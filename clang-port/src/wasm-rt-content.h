...
inline static std::string wasm_rt_content =
    ...
    "\n"
    "/**\n"
    " * Enable memory checking via a signal handler via the following "
    "definition:\n"
    " *\n"
    ...
    "#else\n"
    "\n"
    "/* The signal handler is not supported, error out if the user was trying "
    "to\n"
    " * enable it. */\n"
    "#if WASM_RT_MEMCHECK_SIGNAL_HANDLER\n"
    ...
    "\n"
    "/**\n"
    " * When the signal handler is not used, stack depth is limited "
    "explicitly.\n"
    " * The maximum stack depth before trapping can be configured by defining\n"
    " * this symbol before including wasm-rt when building the generated c "
    "files,\n"
    " * for example:\n"
    " *\n"
    " * ```\n"
    ...
    "    WASM_RT_TRAP_OOB,                /** Out-of-bounds access in linear "
    "memory or a table. */\n"
    ...
    "*/\n"
    "    WASM_RT_TRAP_UNREACHABLE,        /** Unreachable instruction "
    "executed. */\n"
    ...
    "    uint32_t func_type;\n"
    "    /** The function. The embedder must know the actual C signature of "
    "the\n"
    "     * function and cast to it before calling. */\n"
    "    wasm_rt_function_ptr_t func;\n"
    "    /** A function instance is a closure of the function over an "
    "instance\n"
    ...
    "  static const wasm_rt_funcref_t wasm_rt_funcref_null_value = { 0, NULL, "
    "NULL };\n"
    "\n"
    ...
    "  static const wasm_rt_externref_t wasm_rt_externref_null_value = { 0, 0, "
    "0, 0 };\n"
    "\n"
    "  /** A Memory object. */\n"
    "  typedef struct\n"
    ...
    "    uint8_t* data;\n"
    "    /** The current and maximum page count for this Memory object. If "
    "there is no\n"
    ...
    "   *\n"
    "   * This is typically called by the generated code, and not the "
    "embedder.\n"
    "   */\n"
    ...
    "\n"
    "  /**\n"
    "   * Register a function type with the given signature. The returned "
    "function\n"
    "   * index is guaranteed to be the same for all calls with the same "
    "signature.\n"
    "   * The following varargs must all be of type `wasm_rt_type_t`, first "
    "the\n"
    ...
    "   */\n"
    "  void wasm_rt_load_exception( uint32_t tag, uint32_t size, const void* "
    "values );\n"
    "\n"
    "  /**\n"
    ...
    "   *  ```\n"
    "   */\n"
    "  void wasm_rt_allocate_memory( wasm_rt_memory_t*, uint32_t "
    "initial_pages, uint32_t max_pages );\n"
    "\n"
    ...
    "\n"
    "  /**\n"
    "   * Initialize a funcref Table object with an element count of "
    "`elements` and a\n"
    ...
    "elements, uint32_t max_elements );\n"
    "\n"
    "  /**\n"
